...
def lanes_pkl():
    ...
    with open(f"{out_path}/lanes.pb.txt", 'w') as f:
       f.write(total_pb.__str__())
...
def lane_boundaries_pkl():
    ...
    with open(f"{out_path}/lane_boundaries.pb.txt", 'w') as f:
        f.write(total_pb.__str__())
...
def junctions_pkl():
    ...
    with open(f"{out_path}/junctions.pb.txt", 'w') as f:
        f.write(total_pb.__str__())
...
def stop_lines_pkl():
    ...
    with open(f"{out_path}/stop_lines.pb.txt", 'w') as f:
        f.write(total_pb.__str__())
...
def cross_walks_pkl():
    ...
    with open(f"{out_path}/cross_walks.pb.txt", 'w') as f:
        f.write(total_pb.__str__())
...
def lane_arrows_pkl():
    ...
    with open(f"{out_path}/lane_arrows.pb.txt", 'w') as f:
        f.write(total_pb.__str__())
...
def traffic_signs_pkl():
    ...
    with open(f"{out_path}/traffic_signs.pb.txt", 'w') as f:
        f.write(total_pb.__str__())
...
def traffic_lights_pkl():
    ...
    with open(f"{out_path}/traffic_lights.pb.txt", 'w') as f:
        f.write(total_pb.__str__())
...
def pm_lanes_pkl():
    ...
    with open(f"{out_path}/pm_lanes.pb.txt", 'w') as f:
        f.write(total_pb.__str__())
...
def pm_lane_lines_pkl():
    ...
    with open(f"{out_path}/pm_lane_lines.pb.txt", 'w') as f:
        f.write(total_pb.__str__())
...
def pm_feature_point_pkl():
    ...
    with open(f"{out_path}/pm_feature_points.pb.txt", 'w') as f:
        f.write(total_pb.__str__())
...
def pm_stop_line_pkl():
    ...
    total_pb.stop_lines.extend(total_list)
    with open(f"{out_path}/pm_stop_lines.pb.txt", 'w') as f:
        f.write(total_pb.__str__())
...
def pm_cross_walk_pkl():
    ...
    total_pb.cross_walks.extend(total_list)
    with open(f"{out_path}/pm_cross_walks.pb.txt", 'w') as f:
        f.write(total_pb.__str__())
...
def pm_lane_arrow_pkl():
    ...
    total_pb.lane_arrows.extend(total_list)
    with open(f"{out_path}/pm_lane_arrows.pb.txt", 'w') as f:
        f.write(total_pb.__str__())
...
def pm_junction_light_pkl():
    ...
    with open(f"{out_path}/pm_junction_lights.pb.txt", 'w') as f:
        f.write(total_pb.__str__())
...
def lanes_pkl_correct():
    ...
    with open(f"{out_path}/lanes_correct.pb.txt", 'w') as f:
       f.write(total_pb.__str__())
...
def lane_boundaries_pkl_correct():
    ...
    for mark_id, group in df.groupby('id'):
        ...
        total_list.append(mark)
    total_pb.lane_boundaries.extend(total_list)
    with open(f"{out_path}/lane_boundaries_correct.pb.txt", 'w') as f:
        f.write(total_pb.__str__())
...
def pm_lane_lines_pkl_correct():
    ...
    for line_id,group in df.groupby('line_id'):
        ...
        total_list.append(lane_line)
    total_pb.lane_lines.extend(total_list)
    with open(f"{out_path}/pm_lane_lines_correct.pb.txt", 'w') as f:
        f.write(total_pb.__str__())
